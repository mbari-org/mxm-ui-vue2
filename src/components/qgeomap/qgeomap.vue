...
<script>
  import MapButtons from 'components/qgeomap/map-buttons'
  import MousePosMarker from 'components/qgeomap/mouse-pos-marker'
  import CoordsTable from 'components/qgeomap/coords-table'
